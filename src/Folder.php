 ...
 *
 * This is a port of CakePHP FileSystem Folder class for Yii2.
 */
class Folder
{
    /**
    ...
    public function tree($path = null, $exceptions = false, $type = null)
    {
        ...
        try {
            $directory = new RecursiveDirectoryIterator(
                $path, RecursiveDirectoryIterator::KEY_AS_PATHNAME | RecursiveDirectoryIterator::CURRENT_AS_SELF
            );
     ...
     * - `scheme` self::MERGE, self::OVERWRITE, self::SKIP
